          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <Card key={index} className="border-slate-200 shadow-sm hover:shadow-md transition-shadow group">
                <CardHeader>
                  <div className={`p-3 bg-${service.color}-100 rounded-xl w-fit mb-4 group-hover:bg-${service.color}-200 transition-colors`}>
                ...
                <CardContent>
                  ...
                  <Button variant="ghost" className={`p-0 text-${service.color}-600 hover:text-${service.color}-700 hover:bg-transparent`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {[
              ...
              <Card key={index} className="border-slate-200 shadow-sm hover:shadow-md transition-shadow overflow-hidden">
                <CardHeader>
                  <Badge className={`w-fit mb-3 bg-${news.color}-100 text-${news.color}-800 hover:bg-${news.color}-100 border-0`}>
                    {news.badge}
                  </Badge>
