...
import { VerifyPaymentDetailsClient } from "./verify-payment-details-client"
...
export default async function VerifyPaymentDetailsPage() {
  const [paymentDetails, schemeNames] = await Promise.all([fetchPaymentDetails(), fetchSchemeNames()])

  return <VerifyPaymentDetailsClient initialPaymentDetails={paymentDetails} schemeNames={schemeNames} />
}
