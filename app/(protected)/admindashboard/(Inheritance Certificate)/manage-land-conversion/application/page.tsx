...
export default function LandConversionApplicationPage() {
  ...
  const handleSubmit = async (action: "draft" | "submit") => {
    ...
    try {
      const { createLandConversionApplication, submitLandConversionApplication } = await import("../actions");
      ...
      const result = await createLandConversionApplication({
        ...
        state: form.state,
        landAreaDec: form.landAreaDec,
        presentLandUse: form.presentLandUse,
        proposedLandUse: form.proposedLandUse,
      });
      ...
      if (action === "submit" && result.data?.id) {
        await submitLandConversionApplication(result.data.id);
      }
